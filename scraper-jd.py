...
class JDWrapper(object):
    ...
    def login_by_QR(self):
        ...
        try:
            ...
            ## save QR code
            image_file1 = 'qr.png'
            image_file='qr_border.png'
            with open(image_file1, 'wb') as f:
                for chunk in resp.iter_content(chunk_size=1024):
                    f.write(chunk)
            self.add_border_qr(image_file1,image_file)
    ...
    def order_info(self, submit=False):
        ...
        return False
    def add_border_qr(self,image,dst_img):
        old_im = Image.open(image)

        old_size = old_im.size

        new_size = (800, 800)
        new_im = Image.new("RGB", new_size,128)  ## luckily, this is already black!
